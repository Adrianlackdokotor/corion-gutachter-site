...
## Recent Changes
- 2026-04-27: Added GA4 tracking (G-RYF77GKESM) with EU cookie consent — assets/corion-analytics.js handles consent-mode-v2 (denied by default), cookie banner (DE/RO bilingual), dynamic GA script load on accept, dataLayer interception forwarding whatsapp_click_ro/lead_form_submit_ro events, generic WhatsApp click tracking for all pages; added Google Maps / Recenzii footer link on all 15 pages (DE+RO); cleaned GA placeholder from ro/index.html.
